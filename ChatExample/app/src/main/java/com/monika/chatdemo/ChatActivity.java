...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (message.length() > 0) {
                    ...
                    cometchat.sendMessage(String.valueOf(friendId), message,false, new Callbacks() {
                        ...
                        public void failCallback(JSONObject response) {
                            Toast.makeText(ChatActivity.this, "Error in sending message", Toast.LENGTH_SHORT)
                                    .show();
                        }
                    });
                } else {
                    Toast.makeText(ChatActivity.this, "Blank message", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        final ArrayAdapter<String> mAdapter = new ArrayAdapter<String>(this, R.layout.row_listview);
